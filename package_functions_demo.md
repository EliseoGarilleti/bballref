...
This document demonstrates all functions available in the bballref
package with examples and sample output.
...
**Total rows:** 73 **Seasons:** 2022, 2023, 2024
...
1.  [`player_per_game()`](https://eliseogarilleti.github.io/bballref/reference/player_per_game.md) -
    Per game stats
2.  [`player_totals()`](https://eliseogarilleti.github.io/bballref/reference/player_totals.md) -
    Season totals
3.  [`player_per_minute()`](https://eliseogarilleti.github.io/bballref/reference/player_per_minute.md) -
    Per 36 minutes
4.  [`player_per_poss()`](https://eliseogarilleti.github.io/bballref/reference/player_per_poss.md) -
    Per 100 possessions
5.  [`player_advanced()`](https://eliseogarilleti.github.io/bballref/reference/player_advanced.md) -
    Advanced stats
6.  [`player_shooting()`](https://eliseogarilleti.github.io/bballref/reference/player_shooting.md) -
    Shooting by distance
7.  [`player_pbp()`](https://eliseogarilleti.github.io/bballref/reference/player_pbp.md) -
    Play-by-play
8.  [`player_stats_bulk()`](https://eliseogarilleti.github.io/bballref/reference/player_stats_bulk.md) -
    **NEW** - Multiple players

### Team Functions (11):

**Season-Specific (8):** 1.
[`team_per_game()`](https://eliseogarilleti.github.io/bballref/reference/team_per_game.md) -
Per game stats 2.
[`team_totals()`](https://eliseogarilleti.github.io/bballref/reference/team_totals.md) -
Season totals 3.
[`team_advanced()`](https://eliseogarilleti.github.io/bballref/reference/team_advanced.md) -
Advanced stats 4.
[`team_roster()`](https://eliseogarilleti.github.io/bballref/reference/team_roster.md) -
Roster info 5.
[`team_per_minute()`](https://eliseogarilleti.github.io/bballref/reference/team_per_minute.md) -
Per 36 minutes 6.
[`team_per_poss()`](https://eliseogarilleti.github.io/bballref/reference/team_per_poss.md) -
Per 100 possessions 7.
[`team_shooting()`](https://eliseogarilleti.github.io/bballref/reference/team_shooting.md) -
Shooting stats 8.
[`team_pbp()`](https://eliseogarilleti.github.io/bballref/reference/team_pbp.md) -
Play-by-play

**Historical/Aggregate (3):** 9.
[`team_stats_totals()`](https://eliseogarilleti.github.io/bballref/reference/team_stats_totals.md) -
Historical totals (**Enhanced** with year filter) 10.
[`team_stats_per_game()`](https://eliseogarilleti.github.io/bballref/reference/team_stats_per_game.md) -
Historical per game (**Enhanced** with year filter) 11.
[`team_stats_bulk()`](https://eliseogarilleti.github.io/bballref/reference/team_stats_bulk.md) -
**NEW** - Multiple teams/years

### League Functions (3):

1.  [`league_per_game()`](https://eliseogarilleti.github.io/bballref/reference/league_per_game.md) -
    League per game averages
2.  [`league_totals()`](https://eliseogarilleti.github.io/bballref/reference/league_totals.md) -
    League totals
3.  [`league_per_poss()`](https://eliseogarilleti.github.io/bballref/reference/league_per_poss.md) -
    League per 100 poss

### Championship Data (1):

1.  [`champions()`](https://eliseogarilleti.github.io/bballref/reference/champions.md) -
    NBA championship history

### Season Type Support

All player and team functions support `season_type` parameter: -
`"regular"` - Regular season (default) - `"playoffs"` - Postseason
...
- [`team_stats_bulk()`](https://eliseogarilleti.github.io/bballref/reference/team_stats_bulk.md) -
  Fetch multiple teams/years at once
- [`player_stats_bulk()`](https://eliseogarilleti.github.io/bballref/reference/player_stats_bulk.md) -
